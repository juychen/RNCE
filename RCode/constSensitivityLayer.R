...
constSensitivityLayer <- function(sensDat,method="pearson") {
  
  # Correlation for Sensivity
  sensCor <- cor(sensDat, method = method, use = "pairwise.complete.obs")
  ...
  #sensAff <- k_reciprocal_nn(sensAff,KK = 192) * sensAff
