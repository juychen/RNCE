...
#integrtStrctSensPert<-sensAffMat
...
apcomb<-affinClustering(combi,K=33)
...
emf(paste(subDir,"plot_network_nci60_targchembl_exemp.emf",sep="/"),height=5.5,width=5.5,family  = "Times")
